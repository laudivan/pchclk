...
- [x] **Employee PWA UI**: Offline sync, registration, last 3 months local reports, camera QR-scanner.
...
- [x] End-to-end Containerization testing under Podman.
- [x] PWA service-workers caching verification.
